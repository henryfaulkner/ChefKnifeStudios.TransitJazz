...
**Performance Goals**: ≥40% (target 45–50%) per-vehicle wire reduction; ≥70% route-data transfer reduction; zero live-update egress for hidden+muted sessions; ~60–75% total egress reduction vs. Phase 0 measured baseline
